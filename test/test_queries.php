<?php
    ...
    ORM::for_table('widget')->inner_join('widget_handle', array('widget_handle.widget_id', '=', 'widget.id'))->find_all();
    ...
    ORM::for_table('widget')->left_outer_join('widget_handle', array('widget_handle.widget_id', '=', 'widget.id'))->find_all();
    ...
    ORM::for_table('widget')->right_outer_join('widget_handle', array('widget_handle.widget_id', '=', 'widget.id'))->find_all();
    ...
    ORM::for_table('widget')->full_outer_join('widget_handle', array('widget_handle.widget_id', '=', 'widget.id'))->find_all();
    ...
    ORM::for_table('widget')->table_alias('w')->find_all();
    $expected = "SELECT * FROM `widget` `w`";
    Tester::check_equal("Main table alias", $expected);

    ORM::for_table('widget')->join('widget_handle', array('wh.widget_id', '=', 'widget.id'), 'wh')->find_all();
    $expected = "SELECT * FROM `widget` JOIN `widget_handle` `wh` ON `wh`.`widget_id` = `widget`.`id`";
    Tester::check_equal("Join with alias", $expected);

    ORM::for_table('widget')->join('widget_handle', "widget_handle.widget_id = widget.id")->find_all();
    $expected = "SELECT * FROM `widget` JOIN `widget_handle` ON widget_handle.widget_id = widget.id";
    Tester::check_equal("Join with string constraint", $expected);

    ORM::for_table('widget')->distinct()->select('name')->find_all();
    ...
    $widget = ORM::for_table('widget')->find_first(1);
    $widget->name = "Fred";
    $widget->age = 10;
    $widget->save();
    ...
    $widget = ORM::for_table('widget')->select('widget.*')->find_first();
    ...
    ORM::for_table('widget_handle')->find_first(5);
    ...
    ORM::for_table('widget_nozzle')->find_first(5);
    ...
    ORM::for_table('widget')->where('name', 'Fred')->where('age', 17)->find_first();
    ORM::for_table('widget')->where('name', 'Bob')->where('age', 42)->find_first();
    $expected = ORM::get_last_query();
    ORM::for_table('widget')->where('name', 'Fred')->where('age', 17)->find_first(); // this shouldn't run a query!
